...
(function() {
  $(function() {
    var $body, $main, addPalette, addStyle, font, init, iscp, onYouTubeIframeAPIReady, palettes, player, purchase, qr, random, rbma, resize, shuffle, styles, theStyle, wiggle, wrapColor;
    $body = $('body');
    $main = $('main');
